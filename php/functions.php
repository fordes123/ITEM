...
function themeConfig(Typecho_Widget_Helper_Form $form)
{
    ...
    <div class="col-mb-12">
        <div class="badge">
            ...
            <h1>ITEM<sup id="currentVersion"><?php echo Theme_Constants::THEME_VERSION ?></sup></h1>
        </div>
    ...
    $form->addItem(Theme_Utils::createHtmlWidget($form, '<h2>基础设置</h2>'));
    ...
    $form->addItem(Theme_Utils::createHtmlWidget($form, '<hr color="#ECECEC"/><h2>进阶设置</h2>'));
    ...
    $form->addItem(Theme_Utils::createHtmlWidget($form, '<hr color="#ECECEC"/><h2>高级设置</h2>'));
