            ...
            <div class="card card-xl">
                <div class="card-body">
                    ...
                    <div class="post-actions row g-2 mt-4">
                        ...
                        <div class="col-12 col-md-7"> <a href="<?php $this->fields->url(); ?>" title="<?php $this->title() ?>" target="_blank" class="btn btn-primary btn-lg btn-block btn-goto">跳转 <i class="text-lg fas fa-arrow-right"></i></a></div>
                    </div>
                </div>
            </div>
            <?php if ($this->is('post')) :
